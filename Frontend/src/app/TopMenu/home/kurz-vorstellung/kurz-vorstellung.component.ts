...
export class KurzVorstellungComponent implements OnInit, OnDestroy{
  ...
  tabContents = [
    { left: 'image', right: 'text', imageUrl: 'assets/images/ich_rund.jpg', title: 'Wer bin ich?', description: 'Ein Webentwickler mit über drei Jahren Erfahrung verfügt. Meine Expertise liegt sowohl im Frontend als auch im Backend. Das bedeutet, dass ich sowohl die Benutzeroberfläche einer Seite bzw. Anwendung, als auch eine eventuell nötige Datenbankanbindung selbstständig programmiere. Zeit der aufgrund seiner Erfahrung sowohl das Frontend als auch das Backend programmieren kann. Sie erhalten so Ihre Webseite oder App aus einer Hand. Auf diese Weise kann ich Sie beim Erreichen Ihrer Ziele schnell und umfassend unterstützen.' },
